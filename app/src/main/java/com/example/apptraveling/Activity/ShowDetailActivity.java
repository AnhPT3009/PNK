...
import com.example.apptraveling.Utils.Utils;
import com.example.apptraveling.models.Cart;
import com.example.apptraveling.models.SkDetail;
import com.example.apptraveling.models.SkDetailModel;
import com.example.apptraveling.viewModels.ShowDetailViewModels;
...
public class ShowDetailActivity extends AppCompatActivity {
    ...
    private void addToCart(int amount) {
        ...
        if (Utils.cartList.size() > 0) {
            for (int i = 0; i < Utils.cartList.size(); i++) {
                if (Utils.cartList.get(i).getMealDetail().getId() == skDetail.getId()) {
                    checkExit = true;
                    n = i;
                    break;
                }
